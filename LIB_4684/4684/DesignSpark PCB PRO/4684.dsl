...
(library Library_1
	...
	(patternDef "4684" (originalName "4684")
		...
		(layerContents (layerNumRef 18)
			(line (pt 1.8 -0.55) (pt 1.8 -0.55) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt 1.75, -0.55) (radius 0.05) (startAngle .0) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 1.7 -0.55) (pt 1.7 -0.55) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt 1.75, -0.55) (radius 0.05) (startAngle 180.0) (sweepAngle 180.0) (width 0.1))
		)
	)
